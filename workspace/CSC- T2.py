...
class BruteForce:
    ...
    def get_times(self):
        ...
        self.totalseconds=self.num_routes*self.rate
...
def bruteforce_test_suite():
    ...
    tsp1 = BruteForce(11, 0.05) # visit 11 cities using a
    ...
    tsp2 = BruteForce(7, 0.05) # visit 11 cities using a
...
def main():
    ...
    num = int(raw_input("Please enter the number of cities you wish to visit: "))
    rate = float(raw_input('Please enter the rate of checking number of seconds per route: '))
